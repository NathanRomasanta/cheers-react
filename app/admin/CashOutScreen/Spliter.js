...
function Spliter({ children, title, title2 }) {
  ...
  return (
    <div className='flex  h-full w-full justify-center items-center '>
      <div className='card  rounded-box grid h-full flex-grow place-items-center  justify-center items-center '>
      ...
      {secondChild && (
        <>
          ...
          <div className='card bg-opacity-0 rounded-box grid h-full flex-grow place-items-center '>
